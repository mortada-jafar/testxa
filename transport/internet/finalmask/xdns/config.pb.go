...
type Config struct {
	...
	MaxQnameLen     uint32                 `protobuf:"varint,2,opt,name=max_qname_len,json=maxQnameLen,proto3" json:"max_qname_len,omitempty"`
	PollIntervalMs  uint32                 `protobuf:"varint,3,opt,name=poll_interval_ms,json=pollIntervalMs,proto3" json:"poll_interval_ms,omitempty"`
	PollConcurrency uint32                 `protobuf:"varint,4,opt,name=poll_concurrency,json=pollConcurrency,proto3" json:"poll_concurrency,omitempty"`
...
func (x *Config) GetMaxQnameLen() uint32 {
	if x != nil {
...
func (x *Config) GetPollConcurrency() uint32 {
	if x != nil {
		return x.PollConcurrency
	}
	return 0
}
...
const file_transport_internet_finalmask_xdns_config_proto_rawDesc = "" +
	"\n" +
	".transport/internet/finalmask/xdns/config.proto\x12&xray.transport.internet.finalmask.xdns\"\x99\x01\n" +
	"\x06Config\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domain\x12\"\n" +
	"\rmax_qname_len\x18\x02 \x01(\rR\vmaxQnameLen\x12(\n" +
	"\x10poll_interval_ms\x18\x03 \x01(\rR\x0epollIntervalMs\x12)\n" +
	"\x10poll_concurrency\x18\x04 \x01(\rR\x0fpollConcurrencyB\x94\x01\n" +
